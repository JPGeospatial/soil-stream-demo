...
function exp_TilesLines_15rule0_eval_expression(context) {
    // ChildIDs IS NOT 'None'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ChildIDs')  !== 'None');
    } else {
        return (feature.get('ChildIDs')  !== 'None');
    }
}
...
function exp_TilesLines_15rule1_eval_expression(context) {
    // ChildIDs IS 'None'
